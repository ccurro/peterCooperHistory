...
% Add Board of Ed, FDNY, and JEllo
\begin{document}
\centering
...
and 34th streets {\fontspec{Gibbs Medium} incurring no debt}.
\newcounter{enumTemp}
...
{\fontspec{Gibbs Medium} oldest person} to be nominated by a political party for
the presidency.
...
funeral procession, describing the {\fontspec{Gibbs Medium} thousands of people
...
\item Peter Cooper is buried at {\fontspec{Gibbs Medium} Green-Wood Cemetery} in
...
\bibliography{bib}
\scshape \fontsize{16pt}{16pt}\selectfont \fontspec{Gibbs Bold} About
