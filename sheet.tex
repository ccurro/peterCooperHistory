...
\usepackage{fontspec}
\defaultfontfeatures{VerticalPosition=Ordinal,Ligatures={TeX,Common,Rare},Contextuals={Alternate}}
\setmainfont{Gibbs Book}
\newfontface\mdseries{Gibbs Medium}
\newfontface\bdseries{Gibbs Bold}
\newfontface\bkseries{Gibbs Black}
\pagestyle{empty}
...
\setlist[enumList]{label=\bdseries\arabic*.}

\renewcommand{\refname}{\scshape \fontsize{16pt}{16pt}\selectfont \fontspec{Gibbs Bold} References}
\begin{document}
\centering
\fontspec{Gibbs Bold}
...
\scshape 
\addfontfeature{LetterSpace=0.1} peter cooper \\
\addfontfeature{Scale=0.85,LetterSpace=3.5} a model citizen
